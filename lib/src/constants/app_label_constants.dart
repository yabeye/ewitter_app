class KApp {
  static const String title = "Ewitter App";
  static const String description =
      "Ewitter is a free social networking site in Ethiopia where users broadcast short posts. These posts can contain text, photos or links.";
